...
public class ModificarEjercicioBotonVolverActivityTest {
    ...
    @Test
    public void modificarEjercicioBotonVolverActivityTest() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.EjerTitle),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("vacio"), closeSoftKeyboard());
