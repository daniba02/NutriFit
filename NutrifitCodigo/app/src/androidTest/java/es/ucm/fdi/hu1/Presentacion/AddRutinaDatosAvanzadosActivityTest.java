...
public class AddRutinaDatosAvanzadosActivityTest {
    ...
    @Test
    public void addRutinaDatosAvanzadosActivityTest() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.RutinaTitle),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("Prueba rutina 1"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.RutinaDetails),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("Rutina pecho 1"), closeSoftKeyboard());
