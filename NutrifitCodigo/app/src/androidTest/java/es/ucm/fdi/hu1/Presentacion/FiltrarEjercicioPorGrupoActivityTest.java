...
public class FiltrarEjercicioPorGrupoActivityTest {
    ...
    @Test
    public void filtrarEjercicioPorGrupoActivityTest() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.EjerTitle),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("pecho"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.EjerTitle),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("biceps"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.EjerTitle),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("vacio"), closeSoftKeyboard());
