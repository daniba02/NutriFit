...
public class FiltrarEjericioPorTipoActivityTest {
    ...
    @Test
    public void filtrarEjericioPorTipoActivityTest() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.EjerTitle),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("fuerza"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.EjerTitle),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("cardio"), closeSoftKeyboard());
